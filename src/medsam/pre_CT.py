...
def preprocess_ct(gt_path, nii_path, gt_name, image_name, label_id, image_size, sam_model, device='cuda:0'):
...
for name in tqdm(train_names):
    ...
    gt_name = name 
    imgs, gts, img_embeddings = preprocess_ct(args.gt_path, args.nii_path, gt_name, image_name, args.label_id, args.image_size, sam_model, device=args.device)
    #%% save to npz file
